...
export const personalities: PersonalityProfile[] = [
  {
    ...
    accent: "#FB7185",
    accentSoft: "#FCE7F3",
    dominantClause: "you follow the energy in the room",
    secondaryClause: "then want the room to be full",
  ...
  },
  {
    ...
    accent: "#22D3EE",
    accentSoft: "#D1FAE5",
    dominantClause: "you would rather find it than be sent to it",
    secondaryClause: "then wander off the plan to see what is there",
  ...
  },
  {
    ...
    accent: "#A78BFA",
    accentSoft: "#EDE9FE",
    dominantClause: "you plan carefully",
    secondaryClause: "then hold out for the version worth doing properly",
  ...
  },
  {
    ...
    accent: "#2DD4BF",
    accentSoft: "#DBEAFE",
    dominantClause: "you build the day around the people in it",
    secondaryClause: "then pull the people you like into it",
  ...
  },
  {
    ...
    accent: "#C084FC",
    accentSoft: "#FFEDD5",
    dominantClause: "you go where the city is making something",
    secondaryClause: "then look for the work behind it",
  ...
  },
  {
    ...
    accent: "#FBBF24",
    accentSoft: "#FEF3C7",
    dominantClause: "you let the table set the pace",
    secondaryClause: "then slow it down for a good one",
  ...
  },
  {
    ...
    accent: "#F87171",
    accentSoft: "#FEE2E2",
    dominantClause: "you want the day to move",
    secondaryClause: "then push it further than planned",
  ...
  },
  {
    ...
    accent: "#38BDF8",
    accentSoft: "#CFFAFE",
    dominantClause: "you make every hour earn its place",
    secondaryClause: "then keep it sharp so nothing drags",
